...
Reads all 10 well-known fields from a schema entry's Domain Payload:
...
// Extract reads all 10 well-known fields from the schema entry's Domain Payload.
